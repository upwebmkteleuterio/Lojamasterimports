  ...
  return (
    <div className="group animate-in fade-in duration-700">
      <Link to={`/${currentShop}/produto/${product.id}`} className="block">
        {/* Imagem Quadrada (1:1) - Ideal para manter o equilíbrio */}
        <div className="relative aspect-square overflow-hidden bg-gray-50 border border-gray-100 mb-4 rounded-sm">
          <img 
