    ...
    const html = `
      ...
      <body>
        <div class="receipt-container">
          ...
          <div class="section"><div class="section-title">Endereço de Entrega</div><div class="data-value" style="font-weight: normal; font-size: 11px;">${order.customer_data.address}, ${order.customer_data.number}<br>${order.customer_data.city} - ${order.customer_data.state} | CEP: ${order.customer_data.zipCode}</div></div>
